...
<head>
    ...
    <title>C & C++ Programming Course - RR Institute</title>
    <meta name="description" content="Build a strong foundation in programming with C and C++. Learn logic building, data structures, and object-oriented programming.">
